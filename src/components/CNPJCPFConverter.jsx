...
const CNPJCPFConverter = () => {
  ...
  // If activeState is TRUE => format each chunk as CPF, else CNPJ
  const handleConversion = (value) => {
    return value
      .split(/\s+/)
      .map((chunk) => (activeState ? formatCPF(chunk) : formatCNPJ(chunk)))
      .join(" ");
  };
  ...
  return (
    <div
      className="
        ...
        justify-center
      ">
      <h1 className="text-4xl font-bold mb-5">Conversor CNPJ/CPF</h1>
      ...
      <div
        ...
        ">
        <textarea
          placeholder="Digite seu(s) CPF/CNPJ sem formatação aqui"
...
export default CNPJCPFConverter;